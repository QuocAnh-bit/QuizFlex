...
const routes = [
  ...
  { path: '/homework-rooms/join', name: 'homework-room-join', component: () => import('@/views/homework/HomeworkRoomJoin.vue'), meta: { layout: 'user', title: 'Tham gia room homework', requiresAuth: true, roles: workspaceRoles } },
  { path: '/homework-rooms/:roomId', name: 'homework-room-detail', component: () => import('@/views/homework/HomeworkRoomDetail.vue'), meta: { layout: 'user', title: 'Chi tiết room homework', requiresAuth: true, roles: workspaceRoles } },
  { path: '/homework-rooms/:roomId/assignments/create', name: 'homework-assignment-create', component: () => import('@/views/homework/HomeworkAssignmentCreate.vue'), meta: { layout: 'user', title: 'Giao quiz', requiresAuth: true, roles: workspaceRoles } },
  { path: '/homework-rooms/:roomId/assignments/:assignmentId/attempts', name: 'homework-assignment-attempts', component: () => import('@/views/homework/HomeworkAssignmentAttempts.vue'), meta: { layout: 'user', title: 'Bài nộp homework', requiresAuth: true, roles: workspaceRoles } },
  { path: '/homework-rooms/:roomId/assignments/:assignmentId/take', name: 'homework-assignment-take', component: () => import('@/views/homework/HomeworkAssignmentTake.vue'), meta: { layout: 'user', title: 'Làm bài homework', requiresAuth: true, roles: workspaceRoles } },
  { path: '/live-rooms', name: 'live-rooms', component: () => import('@/views/live/LiveRooms.vue'), meta: { layout: 'user', title: 'Live Room', requiresAuth: true, roles: workspaceRoles } },
  { path: '/live-rooms/create', name: 'live-room-create', component: () => import('@/views/live/LiveRoomCreate.vue'), meta: { layout: 'user', title: 'Tạo live room', requiresAuth: true, roles: workspaceRoles } },
  { path: '/live-rooms/join', name: 'live-room-join', component: () => import('@/views/live/LiveRoomJoin.vue'), meta: { layout: 'user', title: 'Tham gia live room', requiresAuth: true, roles: workspaceRoles } },
  { path: '/live-rooms/:liveRoomId/host', name: 'live-room-host', component: () => import('@/views/live/LiveRoomHost.vue'), meta: { layout: 'user', title: 'Host live room', requiresAuth: true, roles: workspaceRoles } },
  { path: '/live-rooms/:liveRoomId/play', name: 'live-room-play', component: () => import('@/views/live/LiveRoomPlay.vue'), meta: { layout: 'user', title: 'Chơi live room', requiresAuth: true, roles: workspaceRoles } },
  { path: '/live-rooms/:liveRoomId/leaderboard', name: 'live-room-leaderboard', component: () => import('@/views/live/LiveRoomLeaderboard.vue'), meta: { layout: 'user', title: 'Leaderboard live room', requiresAuth: true, roles: workspaceRoles } },
  ...
  { path: '/dashboard/questions/create', name: 'user-question-create', component: () => import('@/views/admin/QuizEditorCombined.vue'), meta: { layout: 'user', title: 'Tạo quiz', requiresAuth: true, roles: workspaceRoles } },
  { path: '/dashboard/questions/edit/:id', name: 'user-question-edit', component: () => import('@/views/admin/QuizEditorCombined.vue'), meta: { layout: 'user', title: 'Sửa quiz', requiresAuth: true, roles: workspaceRoles } },
  ...
  { path: '/admin/questions/create', name: 'admin-question-create', component: () => import('@/views/admin/QuizEditorCombined.vue'), meta: { layout: 'admin', title: 'Tạo quiz admin', requiresAuth: true, roles: adminRoles } },
  { path: '/admin/questions/edit/:id', name: 'admin-question-edit', component: () => import('@/views/admin/QuizEditorCombined.vue'), meta: { layout: 'admin', title: 'Sửa quiz admin', requiresAuth: true, roles: adminRoles } },
