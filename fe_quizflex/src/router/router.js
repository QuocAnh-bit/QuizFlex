...
const routes = [
  ...
  { path: '/rooms', name: 'rooms', component: () => import('@/views/user/Rooms.vue'), meta: { layout: 'user', title: 'Rooms của tôi' } },
  { path: '/rooms/:roomId', name: 'room-detail', component: () => import('@/views/user/RoomDetail.vue'), meta: { layout: 'user', title: 'Chi tiết room' } },
  ...
  { path: '/rooms/:roomId/assignments/:assignmentId', name: 'assignment-detail', component: () => import('@/views/user/AssignmentDetail.vue'), meta: { layout: 'user', title: 'Chi tiết homework' } },
  { path: '/rooms/:roomId/assignments/:assignmentId/do', name: 'assignment-play', component: () => import('@/views/user/AssignmentPlay.vue'), meta: { layout: 'user', title: 'Làm homework' } },
  { path: '/rooms/:roomId/assignments/:assignmentId/result', name: 'assignment-result', component: () => import('@/views/user/AssignmentResult.vue'), meta: { layout: 'user', title: 'Kết quả homework' } },
