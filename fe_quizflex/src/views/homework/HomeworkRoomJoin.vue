  ...
  <section class="mx-auto max-w-2xl py-12">
    <article class="relative overflow-hidden rounded-[2rem] border border-[var(--border)] bg-[var(--surface)] p-8 text-center shadow-[var(--shadow-soft)] backdrop-blur-2xl">
      ...
      <div class="relative z-10">
        ...
        <h1 class="mt-2 text-4xl font-black tracking-[-0.06em] text-[var(--text)] md:text-5xl">Tham gia bằng mã phòng</h1>
        <p class="mt-4 text-sm leading-7 text-[var(--muted)]">Nhập mã phòng bài tập để tham gia và xem các bài được giao.</p>
        ...
        <div class="mt-5 grid gap-3 text-left sm:grid-cols-2">
          <div class="rounded-2xl border border-[var(--border)] bg-[var(--surface-soft)] p-4">
            ...
            <p class="mt-2 text-sm font-bold leading-6 text-[var(--muted)]">Sau khi tham gia, bạn sẽ thấy các bài được giao trong phòng.</p>
          </div>
          <div class="rounded-2xl border border-[var(--border)] bg-[var(--surface-soft)] p-4">
            <p class="text-xs font-black uppercase tracking-[0.16em] text-[var(--primary)]">Result</p>
            <p class="mt-2 text-sm font-bold leading-6 text-[var(--muted)]">Kết quả hiển thị theo cấu hình của chủ phòng.</p>
          </div>
        </div>
