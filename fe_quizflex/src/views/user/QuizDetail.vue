<template>
  <section class="py-8">
    <Transition name="fade" mode="out-in">
      ...
      >
        <template #actions>
          <router-link class="btn-ghost text-xs" to="/quizzes">Danh sách quiz</router-link>
        </template>
      </AppErrorState>

      <!-- 3. LOADED STATE: Giao diện chính và Sidebar hiển thị cùng lúc -->
      <div v-else-if="quiz" class="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
