      ...
      >
        ...
        <div class="relative z-10 flex items-center justify-between gap-4">
          ...
          <div class="hidden shrink-0 items-center gap-3 xl:flex">
            ...
            <template v-else>
              <div
                class="flex items-center gap-3 rounded-full border border-[var(--border)] bg-[var(--surface-soft)] pl-1.5 pr-4 py-1.5"
              >
                <UserAvatar
                  :user="currentUser"
                  size-class="h-8 w-8"
                ...
                <button
                  @click="handleLogout"
                  class="ml-2 text-xs font-black text-rose-500 hover:text-rose-400"
                >
                  Đăng xuất
                </button>
              </div>
